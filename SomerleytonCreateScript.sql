...
create or replace function trg_change_history_trigger() returns trigger as $$
declare
...
begin
  ...
  loop
    ...
    then
      ...
      execute 'create trigger trg_history_trigger before insert or update or delete on '|| quote_ident(name_of) ||'
                       for each row execute procedure trg_change_history_trigger();' ;
