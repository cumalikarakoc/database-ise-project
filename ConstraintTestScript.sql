...
exception when others then
raise notice 'Geslaagd -> Foutmelding (Constraint 2 select)';
end;
$$;
rollback;
...
set state = 'Awaiting payment';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 2 update)';
end;
$$;
rollback;
...
delete from delivery;
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 2 delete)';
end;
$$;
rollback;
...
update "ORDER" set invoice_id = '1';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 3 update)';
end;
$$;
rollback;
...
('Order3', 'Supplier2', 'Not complete', current_date, null);
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 4 insert)';
end;
$$;
rollback;
...
set state = 'Not complete';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 4 update)';
end;
$$;
rollback;
...
delete from discrepancy;
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 4 delete)';
end;
$$;
rollback;
...
(2,'something','Koko','Engeland', '10-10-18', 'Monkey');
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 5 insert)';
end;
$$;
rollback;
...
exception when others then
raise notice 'Geslaagd -> Foutmelding (Constraint 5 update)';
end;
$$;
rollback;
...
('1', 'test', 2, '2019-05-24', '2019-05-26');
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 6 insert)';
end;
$$;
rollback;
...
where animal_id = '1' and Since = '2019-05-25';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 6 update)';
end;
$$;
rollback;
...
(1,'10-10-18','12-12-18',null,'tow','kuala lumper');
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 7 insert)';
end;
$$;
rollback;
...
set loan_type = 'tow';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 7 update)';
end;
$$;
rollback;
...
('sai-2','12-12-2018','pil','BOB','10-10-2018');
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 8 insert)';
end;
$$;
rollback;
...
set next_visit = '10-10-2018';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 8 update)';
end;
$$;
rollback;
...
insert into animal_enclosure values('an-1', 'area', 1, '2019-01-01', '2018-02-02');
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 9 insert)';
end;
$$;
rollback;
...
update animal_enclosure set since = '2019-03-05';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 9 update)';
end;
$$;
rollback;
...
insert into spotted values('an-1', '2018-10-11');
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 10 insert)';
end;
$$;
rollback;
...
update spotted set spot_date = '2018-04-04';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 10 update)';
end;
$$;
rollback;
...
delete from reintroduction where reintroduction_date = '2017-04-04';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 10 delete)';
end;
$$;
rollback;
...
insert into exchange values('an-1', '2019-01-01', '2018-11-25', 'comments', 'to', 'place');
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 11 insert)';
end;
$$;
rollback;
...
update exchange set exchange_date = '2018-03-03';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 11 update)';
end;
$$;
rollback;
...
update mating set mate_id = 'off-1';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 12 update)';
end;
$$;
rollback;
...
insert into offspring values('2019-04-04', 'an offspring', 'an-1', 'an-1');
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 12 insert)';
end;
$$;
rollback;
...
('sai-2', '01-01-19', 'duiven', 'sai-2');
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 13 insert)';
end;
$$;
rollback;
...
set animal_id = 'sai-2';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 13 update)';
end;
$$;
rollback;
...
Insert into discrepancy values (1, 1, 'test', '02-02-2019');
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 14 insert)';
end;
$$;
rollback;
...
Update discrepancy set place_date = '02-02-2019';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 14 update)';
end;
$$;
rollback;
...
insert into line_item values('o123', 'banaan', 10, 0);
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 15 insert)';
end;
$$;
rollback;
...
update line_item set weight = 0;
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 15 update)';
end;
$$;
rollback;
...
insert into line_item values('o123', 'banaan', -1, 10);
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 16 insert)';
end;
$$;
rollback;
...
update line_item set price = -1;
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 16 update)';
end;
$$;
rollback;
...
insert into stock values ('apen', 'bananen', -5);
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 17 insert)';
end;
$$;
rollback;
...
update stock set amount = -5;
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 17 update)';
end;
$$;
rollback;
...
insert into feeding values('1', 'Kapsalon', '11/11/12',0);
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 18 insert)';
end;
$$;
rollback;
...
update feeding set amount = 0;
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 18 update)';
end;
$$;
rollback;
...
insert into animal_visits_vet values('1', '1/1/10', 'Regular check', 'Doctor Pol', '12/12/14');
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 19 insert)';
end;
$$;
rollback;
...
update animal_visits_vet set visit_date = '1/1/10';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 19 update)';
end;
$$;
rollback;
...
insert into species_gender values ('aap', '', 5, -2);
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 20 insert)';
end;
$$;
rollback;
...
update species_gender set maturity_age = -2;
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 20 update)';
end;
$$;
rollback;
...
insert into species_gender values('Apes', 'male', 0, 009.5);
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 21 insert) -> %', SQLERRM;
end;
$$ language 'plpgsql';
rollback;
...
update species_gender set average_weight = 0 where english_name = 'Apes';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 21 update) -> %',SQLERRM ;
end;
$$;
rollback;
...
insert into species_gender values('Apes', 'male', -5, 009.5);
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 21 insert)';
end;
$$;
rollback;
...
update species_gender set average_weight = -5 where english_name = 'Apes';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 21 update)';
end;
$$;
rollback;
...
insert into animal_enclosure values('1', 'Mensen', '1', '1/1/10');
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 22 insert)';
end;
$$;
rollback;
...
update animal_enclosure set since = '1/1/10';
    exception when others then
    raise notice 'Geslaagd -> Foutmelding (Constraint 22 update)';
end;
$$;
rollback;
